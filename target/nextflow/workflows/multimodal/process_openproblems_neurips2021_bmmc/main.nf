// process_openproblems_neurips2021_bmmc build_main
// 
...
meta = [
  ...
  "namespace" : "workflows/multimodal",
  "version" : "build_main",
  "argument_groups" : [
    {
      "name" : "Inputs",
  ...
  "dependencies" : [
    {
      "name" : "loaders/multimodal/openproblems_neurips2021_bmmc",
      "repository" : {
        "type" : "local"
      }
    },
    ...
    {
      "name" : "normalization/log_scran_pooling",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "normalization/sqrt_cp",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "normalization/l1_sqrt",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "normalization/prot_clr",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "normalization/atac_tfidf",
      "repository" : {
        "type" : "local"
      }
    },
    {
      "name" : "processors/subsample",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "license" : "MIT",
  "links" : {
    "repository" : "https://github.com/openproblems-bio/datasets",
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/workflows/multimodal/process_openproblems_neurips2021_bmmc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/workflows/multimodal/process_openproblems_neurips2021_bmmc",
    "viash_version" : "0.9.4",
  ...
  "package_config" : {
    "name" : "datasets",
    "version" : "build_main",
    "description" : "Datasets for benchmarking open problems in single-cell analysis.\n",
    "info" : {
      "test_resources" : [
        {
          "type" : "s3",
    ...
    "links" : {
      "repository" : "https://github.com/openproblems-bio/datasets",
      "docker_registry" : "ghcr.io",
      "issue_tracker" : "https://github.com/openproblems-bio/datasets/issues"
    }
  }
}'''))
]
...
include { openproblems_neurips2021_bmmc } from "${meta.resources_dir}/../../../../nextflow/loaders/multimodal/openproblems_neurips2021_bmmc/main.nf"
include { log_cp } from "${meta.resources_dir}/../../../../nextflow/normalization/log_cp/main.nf"
include { log_scran_pooling } from "${meta.resources_dir}/../../../../nextflow/normalization/log_scran_pooling/main.nf"
include { sqrt_cp } from "${meta.resources_dir}/../../../../nextflow/normalization/sqrt_cp/main.nf"
include { l1_sqrt } from "${meta.resources_dir}/../../../../nextflow/normalization/l1_sqrt/main.nf"
include { prot_clr } from "${meta.resources_dir}/../../../../nextflow/normalization/prot_clr/main.nf"
include { atac_tfidf } from "${meta.resources_dir}/../../../../nextflow/normalization/atac_tfidf/main.nf"
include { subsample } from "${meta.resources_dir}/../../../../nextflow/processors/subsample/main.nf"
include { svd } from "${meta.resources_dir}/../../../../nextflow/processors/svd/main.nf"
include { hvg } from "${meta.resources_dir}/../../../../nextflow/processors/hvg/main.nf"
...
include { decompress_gzip } from "${meta.root_dir}/dependencies/github/openproblems-bio/openproblems/build/main/nextflow/utils/decompress_gzip/main.nf"
