// process_zenodo_slidetags build_main
// 
...
meta = [
  ...
  "dependencies" : [
    {
      "name" : "loaders/spatial/zenodo_slidetags",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/workflows/spatial/process_zenodo_slidetags/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/workflows/spatial/process_zenodo_slidetags",
    "viash_version" : "0.9.4",
...
include { zenodo_slidetags } from "${meta.resources_dir}/../../../../nextflow/loaders/spatial/zenodo_slidetags/main.nf"
