// process_openproblems_op3 build_main
// 
...
meta = [
            ...
            "format" : {
              ...
              "obs" : [
                ...
                },
                {
                  "type" : "string",
                  "name" : "tissue_general_ontology_term_id",
                  "description" : "Ontology term identifier for the general tissue categ''' + '''ory, aiding in standardizing and grouping tissue types.\n\nFor organoid or tissue samples, the Uber-anatomy ontology (`UBERON:`) is used. The term ids must be a child term of `UBERON:0001062` (anatomical entity).\nFor cell cultures, the Cell Ontology (`CL:`) is used. The term ids cannot be `CL:0000255`, `CL:0000257` or `CL:0000548`.\n",
                  "required" : false
                },
                {
                  "type" : "string",
  ...
  "description" : "\\"Fetch, filter, normalize, and prepare datasets from the Open Problems Perturbation Prediction (OP3) dataset \nfor benchmarking and analysis.\\"\n",
  "status" : "enabled",
  "scope" : {
    "image" : "public",
    "target" : "public"
  ...
  "dependencies" : [
    {
      "name" : "loaders/scrnaseq/openproblems_op3",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/workflows/scrnaseq/process_openproblems_op3/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { openproblems_op3 } from "${meta.resources_dir}/../../../../nextflow/loaders/scrnaseq/openproblems_op3/main.nf"
...
include { pca } from "${meta.resources_dir}/../../../../nextflow/processors/pca/main.nf"
include { hvg } from "${meta.resources_dir}/../../../../nextflow/processors/hvg/main.nf"
include { knn } from "${meta.resources_dir}/../../../../nextflow/processors/knn/main.nf"
