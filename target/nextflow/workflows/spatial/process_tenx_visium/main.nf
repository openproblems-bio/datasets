// process_tenx_visium build_main
// 
...
meta = [
  ...
  "dependencies" : [
    {
      "name" : "loaders/spatial/tenx_visium",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/workflows/spatial/process_tenx_visium/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { tenx_visium } from "${meta.resources_dir}/../../../../nextflow/loaders/spatial/tenx_visium/main.nf"
