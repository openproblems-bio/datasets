...
meta = [
  ...
  "description" : "\\"Loads and preprocesses the OP3 dataset from GEO accession GSE279945.\\"\n",
  "info" : {
    "type" : "dataset_loader",
    "type_info" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/loaders/scrnaseq/openproblems_op3/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'cell_type': $( if [ ! -z ${VIASH_PAR_CELL_TYPE+x} ]; then echo "r'${VIASH_PAR_CELL_TYPE//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'perturbation': $( if [ ! -z ${VIASH_PAR_PERTURBATION+x} ]; then echo "r'${VIASH_PAR_PERTURBATION//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/datasets/loaders/scrnaseq/openproblems_op3",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
