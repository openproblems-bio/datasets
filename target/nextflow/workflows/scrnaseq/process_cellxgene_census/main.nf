// process_cellxgene_census build_main
// 
...
meta = [
            ...
            "format" : {
              ...
              "obs" : [
                ...
                },
                {
                  "type" : "string",
                  "name" : "sex_ontology_term_id",
                  "description" : "Ontology term identifier for the biol''' + '''ogical sex, ensuring standardized classification of sex. Only `PATO:0000383`, `PATO:0000384` and `PATO:0001340` are allowed.",
                  "required" : false
                },
                {
                  "type" : "string",
  ...
  "dependencies" : [
    {
      "name" : "loaders/scrnaseq/cellxgene_census",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/datasets/datasets/src/workflows/scrnaseq/process_cellxgene_census/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/workflows/scrnaseq/process_cellxgene_census",
    "viash_version" : "0.9.4",
...
include { cellxgene_census } from "${meta.resources_dir}/../../../../nextflow/loaders/scrnaseq/cellxgene_census/main.nf"
